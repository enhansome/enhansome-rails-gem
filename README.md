...
* [Pundit](https://github.com/elabs/pundit) ⭐ 8,520 | 🐛 13 | 🌐 Ruby | 📅 2026-08-28 - Pundit provides a set of helpers which guide you in leveraging regular Ruby classes and object oriented design patterns to build a simple, robust and scaleable authorization system.
...
* [globalize](https://github.com/globalize/globalize) ⭐ 2,157 | 🐛 11 | 🌐 Ruby | 📅 2026-08-27 - Rails I18n de-facto standard library for ActiveRecord model/data translation.
* [counter\_culture](https://github.com/magnusvk/counter_culture) ⭐ 2,117 | 🐛 3 | 🌐 Ruby | 📅 2026-07-08 - Turbo-charged counter caches for your Rails app. Huge improvements over the Rails standard counter caches.
...
* [goldiloader](https://github.com/salsify/goldiloader) ⭐ 1,670 | 🐛 7 | 🌐 Ruby | 📅 2026-03-19 - Automatic ActiveRecord eager loading to reduce the number of database queries run by your application.
...
* Tagging
  * [ActsAsTaggableOn](https://github.com/mbleigh/acts-as-taggable-on) ⭐ 4,987 | 🐛 70 | 🌐 Ruby | 📅 2026-08-07 - A tagging plugin for Rails applications that allows for custom tagging along dynamic contexts.
...
* [Chartkick](https://github.com/ankane/chartkick) ⭐ 6,527 | 🐛 7 | 🌐 Ruby | 📅 2026-08-15 - Chartkick helps your to create beautiful Javascript charts with one line of Ruby.
...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,004 | 🐛 239 | 🌐 Ruby | 📅 2026-09-01 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,995 | 🐛 1,140 | 🌐 JavaScript | 📅 2026-09-01 - Display documentation that is generated using Grape Swagger.
...
* [Carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,776 | 🐛 49 | 🌐 Ruby | 📅 2026-08-30 - Carrierwave is a classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [ransack](https://github.com/activerecord-hackery/ransack) ⭐ 5,861 | 🐛 156 | 🌐 Ruby | 📅 2026-05-31 - Ransack enables the creation of both simple and advanced search forms for your Ruby on Rails application.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,481 | 🐛 82 | 🌐 Ruby | 📅 2026-08-31 - Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
* [Whenever](https://github.com/javan/whenever) ⭐ 8,858 | 🐛 84 | 🌐 Ruby | 📅 2026-07-01 - Whenever is a Ruby gem that provides a clear syntax for writing and deploying cron jobs.
...
* [meta-tags](https://github.com/kpumuk/meta-tags) ⭐ 2,801 | 🐛 13 | 🌐 Ruby | 📅 2026-09-01 - Search Engine Optimization (SEO) plugin for Ruby on Rails applications.
...
* [Config](https://github.com/railsconfig/config) ⭐ 2,168 | 🐛 25 | 🌐 Ruby | 📅 2026-07-28 - Multi-environment YAML style configurations that helps easily manage environment specific settings in an easy and usable manner.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,896 | 🐛 158 | 🌐 Ruby | 📅 2026-09-01 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,547 | 🐛 74 | 📅 2026-07-20.
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,271 | 🐛 67 | 🌐 Ruby | 📅 2026-09-01 - Rspec-rails is a testing framework for Rails 3.x and 4.x.
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,919 | 🐛 1 | 🌐 Ruby | 📅 2026-09-01 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,266 | 🐛 116 | 🌐 Ruby | 📅 2026-08-13 - Brakeman is a static analysis tool which checks Ruby on Rails applications for security vulnerabilities.
...
* [bundle-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,756 | 🐛 48 | 🌐 Ruby | 📅 2026-08-31 - bundler-audit is a patch-level verification tool for Bundler which checks for vulnerable versions of gems and insecure gem sources.
...
* [Mina](https://github.com/mina-deploy/mina) ⭐ 4,354 | 🐛 35 | 🌐 Ruby | 📅 2024-08-01 - fast deployer and server automation tool.
...
* [Errbit](https://github.com/errbit/errbit) ⭐ 4,270 | 🐛 145 | 🌐 Ruby | 📅 2026-09-01 - Open source notifier gem compliant with Airbrake.
