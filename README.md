...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,008 | 🐛 239 | 🌐 Ruby | 📅 2026-09-12 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,010 | 🐛 1,130 | 🌐 JavaScript | 📅 2026-09-11 - Display documentation that is generated using Grape Swagger.
...
* [Carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,774 | 🐛 42 | 🌐 Ruby | 📅 2026-09-12 - Carrierwave is a classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,475 | 🐛 73 | 🌐 Ruby | 📅 2026-09-11 - Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,956 | 🐛 196 | 🌐 Ruby | 📅 2026-09-11 - RailsAdmin is a Rails engine that provides an easy-to-use interface for managing your data.
...
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,321 | 🐛 8 | 🌐 Objective-C | 📅 2026-08-30 - terminal-notifier is a command-line tool to send Mac OS X User Notifications, which are available in Mac OS X 10.8 and higher.
...
* [awesome\_print](https://github.com/awesome-print/awesome_print) ⭐ 4,076 | 🐛 110 | 🌐 Ruby | 📅 2024-08-15 - Awesome Print is a Ruby library that pretty prints Ruby objects in full color exposing their internal structure with proper indentation.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,900 | 🐛 153 | 🌐 Ruby | 📅 2026-09-12 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,545 | 🐛 73 | 📅 2026-07-20.
...
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,921 | 🐛 1 | 🌐 Ruby | 📅 2026-09-11 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [Secure Headers](https://github.com/twitter/secureheaders) ⭐ 3,227 | 🐛 13 | 🌐 Ruby | 📅 2026-09-11 -  Secure Headers will automatically apply several headers that are related to security.
* [bundle-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 49 | 🌐 Ruby | 📅 2026-09-11 - bundler-audit is a patch-level verification tool for Bundler which checks for vulnerable versions of gems and insecure gem sources.
...
* [Errbit](https://github.com/errbit/errbit) ⭐ 4,270 | 🐛 136 | 🌐 Ruby | 📅 2026-09-11 - Open source notifier gem compliant with Airbrake.
