...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,006 | 🐛 239 | 🌐 Ruby | 📅 2026-09-13 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,009 | 🐛 1,127 | 🌐 JavaScript | 📅 2026-09-14 - Display documentation that is generated using Grape Swagger.
...
* [Carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,774 | 🐛 41 | 🌐 Ruby | 📅 2026-09-15 - Carrierwave is a classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [Sidekiq](https://github.com/mperham/sidekiq) ⭐ 13,555 | 🐛 21 | 🌐 Ruby | 📅 2026-09-03 - Simple, efficient background processing for Ruby.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,474 | 🐛 76 | 🌐 Ruby | 📅 2026-09-14 - Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [meta-tags](https://github.com/kpumuk/meta-tags) ⭐ 2,801 | 🐛 12 | 🌐 Ruby | 📅 2026-09-07 - Search Engine Optimization (SEO) plugin for Ruby on Rails applications.
...
* [dotenv](https://github.com/bkeepers/dotenv) ⭐ 6,762 | 🐛 18 | 🌐 Ruby | 📅 2026-06-22 - Dotenv is a gem that allows you to set your environment variables in .env file, and it will load it in to ENV.
...
* [administrate](https://github.com/thoughtbot/administrate) ⭐ 6,033 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-11 - A Rails engine that helps you put together a super-flexible admin dashboard.
...
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,323 | 🐛 8 | 🌐 Objective-C | 📅 2026-08-30 - terminal-notifier is a command-line tool to send Mac OS X User Notifications, which are available in Mac OS X 10.8 and higher.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,902 | 🐛 155 | 🌐 Ruby | 📅 2026-09-15 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,547 | 🐛 73 | 📅 2026-07-20.
...
* [factory\_bot](https://github.com/thoughtbot/factory_bot) ⭐ 8,170 | 🐛 81 | 🌐 Ruby | 📅 2026-08-21 - Factory\_bot is a fixtures replacement with a straightforward definition syntax, support for multiple build strategies (saved instances, unsaved instances, attribute hashes, and stubbed objects), and support for multiple factories for the same class (user, admin\_user, and so on), including factory inheritance.
...
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,922 | 🐛 1 | 🌐 Ruby | 📅 2026-09-12 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [Rack Attack](https://github.com/kickstarter/rack-attack) ⭐ 5,761 | 🐛 20 | 🌐 Ruby | 📅 2026-09-08 - Rack middleware to blocking & throttling.
...
* [Errbit](https://github.com/errbit/errbit) ⭐ 4,270 | 🐛 147 | 🌐 Ruby | 📅 2026-09-15 - Open source notifier gem compliant with Airbrake.
