...
* [Enumerize](https://github.com/brainspec/enumerize) ⭐ 1,762 | 🐛 12 | 🌐 Ruby | 📅 2026-08-04 - Enumerated attributes with I18n and ActiveRecord/Mongoid support. It can be integrated with Simple Form.
...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,007 | 🐛 248 | 🌐 Ruby | 📅 2026-09-23 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,017 | 🐛 1,131 | 🌐 JavaScript | 📅 2026-09-21 - Display documentation that is generated using Grape Swagger.
...
* [Sidekiq](https://github.com/mperham/sidekiq) ⭐ 13,561 | 🐛 21 | 🌐 Ruby | 📅 2026-09-23 - Simple, efficient background processing for Ruby.
...
* [meta-tags](https://github.com/kpumuk/meta-tags) ⭐ 2,802 | 🐛 13 | 🌐 Ruby | 📅 2026-09-22 - Search Engine Optimization (SEO) plugin for Ruby on Rails applications.
...
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,955 | 🐛 142 | 🌐 Ruby | 📅 2026-09-23 - RailsAdmin is a Rails engine that provides an easy-to-use interface for managing your data.
...
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,337 | 🐛 9 | 🌐 Objective-C | 📅 2026-08-30 - terminal-notifier is a command-line tool to send Mac OS X User Notifications, which are available in Mac OS X 10.8 and higher.
...
* [rails-footnotes](https://github.com/josevalim/rails-footnotes) ⭐ 1,521 | 🐛 17 | 🌐 Ruby | 📅 2026-09-23 - Rails footnotes displays footnotes in your application for easy debugging, such as sessions, request parameters, cookies, filter chain, routes, queries, etc.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,904 | 🐛 149 | 🌐 Ruby | 📅 2026-09-22 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,548 | 🐛 73 | 📅 2026-07-20.
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,275 | 🐛 64 | 🌐 Ruby | 📅 2026-09-23 - Rspec-rails is a testing framework for Rails 3.x and 4.x.
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,925 | 🐛 0 | 🌐 Ruby | 📅 2026-09-23 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,273 | 🐛 119 | 🌐 Ruby | 📅 2026-09-22 - Brakeman is a static analysis tool which checks Ruby on Rails applications for security vulnerabilities.
...
* [bundle-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,759 | 🐛 50 | 🌐 Ruby | 📅 2026-09-22 - bundler-audit is a patch-level verification tool for Bundler which checks for vulnerable versions of gems and insecure gem sources.
...
* [Errbit](https://github.com/errbit/errbit) ⭐ 4,268 | 🐛 144 | 🌐 Ruby | 📅 2026-09-23 - Open source notifier gem compliant with Airbrake.
