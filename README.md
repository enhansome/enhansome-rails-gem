...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,004 | 🐛 240 | 🌐 Ruby | 📅 2026-09-03 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,997 | 🐛 1,137 | 🌐 JavaScript | 📅 2026-09-03 - Display documentation that is generated using Grape Swagger.
...
* [Carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,775 | 🐛 49 | 🌐 Ruby | 📅 2026-08-30 - Carrierwave is a classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [Sidekiq](https://github.com/mperham/sidekiq) ⭐ 13,554 | 🐛 22 | 🌐 Ruby | 📅 2026-09-02 - Simple, efficient background processing for Ruby.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,478 | 🐛 82 | 🌐 Ruby | 📅 2026-08-31 - Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,956 | 🐛 202 | 🌐 Ruby | 📅 2026-09-03 - RailsAdmin is a Rails engine that provides an easy-to-use interface for managing your data.
...
* [byebug](https://github.com/deivid-rodriguez/byebug) ⭐ 3,350 | 🐛 100 | 🌐 Ruby | 📅 2026-07-27 - Byebug is a simple to use, feature rich debugger for Ruby 2. It uses the new TracePoint API for execution control and the new Debug Inspector API for call stack navigation, so it doesn't depend on internal core sources.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,894 | 🐛 152 | 🌐 Ruby | 📅 2026-09-03 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,546 | 🐛 73 | 📅 2026-07-20.
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,272 | 🐛 65 | 🌐 Ruby | 📅 2026-09-03 - Rspec-rails is a testing framework for Rails 3.x and 4.x.
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,919 | 🐛 1 | 🌐 Ruby | 📅 2026-09-03 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [bundle-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 49 | 🌐 Ruby | 📅 2026-09-03 - bundler-audit is a patch-level verification tool for Bundler which checks for vulnerable versions of gems and insecure gem sources.
...
* [Responders](https://github.com/plataformatec/responders) ⭐ 2,057 | 🐛 10 | 🌐 Ruby | 📅 2026-08-27 - A set of Rails responders to dry up your application.
* [Slowpoke](https://github.com/ankane/slowpoke) ⭐ 395 | 🐛 0 | 🌐 Ruby | 📅 2026-04-04 - Rack::Timeout is great. Slowpoke makes it better.

## Error Logging

* [Errbit](https://github.com/errbit/errbit) ⭐ 4,270 | 🐛 149 | 🌐 Ruby | 📅 2026-09-03 - Open source notifier gem compliant with Airbrake.
