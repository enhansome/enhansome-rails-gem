...
* [Devise](https://github.com/plataformatec/devise/) ⭐ 24,359 | 🐛 235 | 🌐 Ruby | 📅 2026-06-22 - Devise is a flexible authentication solution for Rails based on Warden.
...
* [cancancan](https://github.com/CanCanCommunity/cancancan) ⭐ 5,683 | 🐛 91 | 🌐 Ruby | 📅 2026-09-08 - Continuation of CanCan, the authorization Gem for Ruby on Rails.CanCan is an authorization library for Ruby on Rails which restricts what resources a given user is allowed to access. All permissions are defined in a single location (the Ability class) and not duplicated across controllers, views, and database queries.
...
* [Chartkick](https://github.com/ankane/chartkick) ⭐ 6,530 | 🐛 7 | 🌐 Ruby | 📅 2026-08-15 - Chartkick helps your to create beautiful Javascript charts with one line of Ruby.
...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,006 | 🐛 238 | 🌐 Ruby | 📅 2026-09-13 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,011 | 🐛 1,127 | 🌐 JavaScript | 📅 2026-09-11 - Display documentation that is generated using Grape Swagger.
...
* [Carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,774 | 🐛 41 | 🌐 Ruby | 📅 2026-09-12 - Carrierwave is a classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [Sidekiq](https://github.com/mperham/sidekiq) ⭐ 13,554 | 🐛 21 | 🌐 Ruby | 📅 2026-09-03 - Simple, efficient background processing for Ruby.
...
* [Whenever](https://github.com/javan/whenever) ⭐ 8,856 | 🐛 84 | 🌐 Ruby | 📅 2026-07-01 - Whenever is a Ruby gem that provides a clear syntax for writing and deploying cron jobs.
* [Delayed Job](https://github.com/collectiveidea/delayed_job) ⭐ 4,824 | 🐛 142 | 🌐 Ruby | 📅 2026-07-13 - Database based asynchronous priority queue system.
...
* [cocoon](https://github.com/nathanvda/cocoon) ⭐ 3,073 | 🐛 34 | 🌐 Ruby | 📅 2023-08-08 - Dynamic nested forms using jQuery made easy
...
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,322 | 🐛 8 | 🌐 Objective-C | 📅 2026-08-30 - terminal-notifier is a command-line tool to send Mac OS X User Notifications, which are available in Mac OS X 10.8 and higher.
...
* [rails-footnotes](https://github.com/josevalim/rails-footnotes) ⭐ 1,521 | 🐛 17 | 🌐 Ruby | 📅 2026-09-07 - Rails footnotes displays footnotes in your application for easy debugging, such as sessions, request parameters, cookies, filter chain, routes, queries, etc.
...
* [pry-rails](https://github.com/rweng/pry-rails) ⭐ 1,362 | 🐛 33 | 🌐 Ruby | 📅 2024-06-20 - Avoid repeating yourself, use pry-rails instead of copying the initializer to every rails project. This is a small gem which causes rails console to open pry. It therefore depends on pry.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,901 | 🐛 151 | 🌐 Ruby | 📅 2026-09-14 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,546 | 🐛 73 | 📅 2026-07-20.
...
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,921 | 🐛 1 | 🌐 Ruby | 📅 2026-09-12 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,269 | 🐛 118 | 🌐 Ruby | 📅 2026-08-13 - Brakeman is a static analysis tool which checks Ruby on Rails applications for security vulnerabilities.
...
* [Rack Attack](https://github.com/kickstarter/rack-attack) ⭐ 5,760 | 🐛 20 | 🌐 Ruby | 📅 2026-09-08 - Rack middleware to blocking & throttling.
* [Mina](https://github.com/mina-deploy/mina) ⭐ 4,353 | 🐛 35 | 🌐 Ruby | 📅 2024-08-01 - fast deployer and server automation tool.
* [production\_rails](https://github.com/ankane/production_rails) ⭐ 2,321 | 🐛 0 | 📅 2026-03-31 - Best practices for running Rails in production.
...
* [Errbit](https://github.com/errbit/errbit) ⭐ 4,270 | 🐛 143 | 🌐 Ruby | 📅 2026-09-14 - Open source notifier gem compliant with Airbrake.
