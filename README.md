...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,005 | 🐛 237 | 🌐 Ruby | 📅 2026-09-16 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,013 | 🐛 1,123 | 🌐 JavaScript | 📅 2026-09-16 - Display documentation that is generated using Grape Swagger.
...
* [pg\_search](https://github.com/Casecommons/pg_search) ⭐ 1,577 | 🐛 155 | 🌐 Ruby | 📅 2026-09-07 - pg\_search builds ActiveRecord named scopes that take advantage of PostgreSQL's full text search
...
* [administrate](https://github.com/thoughtbot/administrate) ⭐ 6,033 | 🐛 134 | 🌐 JavaScript | 📅 2026-09-11 - A Rails engine that helps you put together a super-flexible admin dashboard.
...
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,324 | 🐛 8 | 🌐 Objective-C | 📅 2026-08-30 - terminal-notifier is a command-line tool to send Mac OS X User Notifications, which are available in Mac OS X 10.8 and higher.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,903 | 🐛 146 | 🌐 Ruby | 📅 2026-09-16 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,548 | 🐛 73 | 📅 2026-07-20.
...
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,922 | 🐛 1 | 🌐 Ruby | 📅 2026-09-15 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,270 | 🐛 118 | 🌐 Ruby | 📅 2026-08-13 - Brakeman is a static analysis tool which checks Ruby on Rails applications for security vulnerabilities.
...
* [Errbit](https://github.com/errbit/errbit) ⭐ 4,269 | 🐛 149 | 🌐 Ruby | 📅 2026-09-16 - Open source notifier gem compliant with Airbrake.
