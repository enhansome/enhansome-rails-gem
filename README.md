...
* [Devise](https://github.com/plataformatec/devise/) ⭐ 24,357 | 🐛 233 | 🌐 Ruby | 📅 2026-06-22 - Devise is a flexible authentication solution for Rails based on Warden.
...
* [cancancan](https://github.com/CanCanCommunity/cancancan) ⭐ 5,685 | 🐛 92 | 🌐 Ruby | 📅 2026-08-09 - Continuation of CanCan, the authorization Gem for Ruby on Rails.CanCan is an authorization library for Ruby on Rails which restricts what resources a given user is allowed to access. All permissions are defined in a single location (the Ability class) and not duplicated across controllers, views, and database queries.
...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,005 | 🐛 237 | 🌐 Ruby | 📅 2026-08-31 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,992 | 🐛 1,140 | 🌐 JavaScript | 📅 2026-08-31 - Display documentation that is generated using Grape Swagger.
...
* [Carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,776 | 🐛 50 | 🌐 Ruby | 📅 2026-08-30 - Carrierwave is a classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [pg\_search](https://github.com/Casecommons/pg_search) ⭐ 1,578 | 🐛 155 | 🌐 Ruby | 📅 2026-08-10 - pg\_search builds ActiveRecord named scopes that take advantage of PostgreSQL's full text search

## Scheduled/Recurrence Jobs

* [Sidekiq](https://github.com/mperham/sidekiq) ⭐ 13,555 | 🐛 22 | 🌐 Ruby | 📅 2026-08-17 - Simple, efficient background processing for Ruby.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,480 | 🐛 82 | 🌐 Ruby | 📅 2026-08-31 - Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [Delayed Job](https://github.com/collectiveidea/delayed_job) ⭐ 4,826 | 🐛 143 | 🌐 Ruby | 📅 2026-07-13 - Database based asynchronous priority queue system.
...
* [meta-tags](https://github.com/kpumuk/meta-tags) ⭐ 2,802 | 🐛 12 | 🌐 Ruby | 📅 2026-08-31 - Search Engine Optimization (SEO) plugin for Ruby on Rails applications.
...
* [administrate](https://github.com/thoughtbot/administrate) ⭐ 6,032 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-26 - A Rails engine that helps you put together a super-flexible admin dashboard.
...
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,300 | 🐛 7 | 🌐 Objective-C | 📅 2026-08-30 - terminal-notifier is a command-line tool to send Mac OS X User Notifications, which are available in Mac OS X 10.8 and higher.
...
* [byebug](https://github.com/deivid-rodriguez/byebug) ⭐ 3,350 | 🐛 99 | 🌐 Ruby | 📅 2026-07-27 - Byebug is a simple to use, feature rich debugger for Ruby 2. It uses the new TracePoint API for execution control and the new Debug Inspector API for call stack navigation, so it doesn't depend on internal core sources.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,898 | 🐛 157 | 🌐 Ruby | 📅 2026-08-31 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,548 | 🐛 74 | 📅 2026-07-20.
...
* [Capybara](https://github.com/jnicklas/capybara) ⭐ 10,173 | 🐛 22 | 🌐 Ruby | 📅 2026-07-13 - Capybara helps you test web applications by simulating how a real user would interact with your app. And drivers:
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,271 | 🐛 68 | 🌐 Ruby | 📅 2026-08-27 - Rspec-rails is a testing framework for Rails 3.x and 4.x.
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,919 | 🐛 1 | 🌐 Ruby | 📅 2026-08-31 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,265 | 🐛 116 | 🌐 Ruby | 📅 2026-08-13 - Brakeman is a static analysis tool which checks Ruby on Rails applications for security vulnerabilities.
...
* [bundle-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 48 | 🌐 Ruby | 📅 2026-08-31 - bundler-audit is a patch-level verification tool for Bundler which checks for vulnerable versions of gems and insecure gem sources.

## Production

* [Capistrano](https://github.com/capistrano/capistrano) ⭐ 12,988 | 🐛 74 | 🌐 Ruby | 📅 2026-07-19 - Remote multi-server automation tool.
* [Rack Attack](https://github.com/kickstarter/rack-attack) ⭐ 5,764 | 🐛 19 | 🌐 Ruby | 📅 2026-07-02 - Rack middleware to blocking & throttling.
...
* [Errbit](https://github.com/errbit/errbit) ⭐ 4,271 | 🐛 142 | 🌐 Ruby | 📅 2026-08-31 - Open source notifier gem compliant with Airbrake.
