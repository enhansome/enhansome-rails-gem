...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,004 | 🐛 239 | 🌐 Ruby | 📅 2026-09-04 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,000 | 🐛 1,125 | 🌐 JavaScript | 📅 2026-09-04 - Display documentation that is generated using Grape Swagger.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,477 | 🐛 82 | 🌐 Ruby | 📅 2026-08-31 - Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,893 | 🐛 152 | 🌐 Ruby | 📅 2026-09-03 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,546 | 🐛 73 | 📅 2026-07-20.
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,273 | 🐛 64 | 🌐 Ruby | 📅 2026-09-03 - Rspec-rails is a testing framework for Rails 3.x and 4.x.
...
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,266 | 🐛 117 | 🌐 Ruby | 📅 2026-08-13 - Brakeman is a static analysis tool which checks Ruby on Rails applications for security vulnerabilities.
...
* [Responders](https://github.com/plataformatec/responders) ⭐ 2,057 | 🐛 11 | 🌐 Ruby | 📅 2026-08-27 - A set of Rails responders to dry up your application.
* [Slowpoke](https://github.com/ankane/slowpoke) ⭐ 395 | 🐛 0 | 🌐 Ruby | 📅 2026-04-04 - Rack::Timeout is great. Slowpoke makes it better.

## Error Logging

* [Errbit](https://github.com/errbit/errbit) ⭐ 4,270 | 🐛 145 | 🌐 Ruby | 📅 2026-09-04 - Open source notifier gem compliant with Airbrake.
