...
* [globalize](https://github.com/globalize/globalize) ⭐ 2,157 | 🐛 10 | 🌐 Ruby | 📅 2026-09-02 - Rails I18n de-facto standard library for ActiveRecord model/data translation.
...
* [Airbrussh](https://github.com/mattbrictson/airbrussh) ⭐ 524 | 🐛 17 | 🌐 Ruby | 📅 2026-09-01 - Airbrussh pretties up your SSHKit and Capistrano output
...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,004 | 🐛 237 | 🌐 Ruby | 📅 2026-09-02 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,997 | 🐛 1,139 | 🌐 JavaScript | 📅 2026-09-01 - Display documentation that is generated using Grape Swagger.
  * [Grape Swagger](https://github.com/ruby-grape/grape-swagger) ⭐ 1,100 | 🐛 132 | 🌐 Ruby | 📅 2026-09-02 - Autogenerate documentation on Grape API.
...
* [shrine](https://github.com/janko-m/shrine) ⭐ 3,286 | 🐛 0 | 🌐 Ruby | 📅 2026-08-28 -File Attachment toolkit for Ruby applications
...
* [Resque](https://github.com/resque/resque) ⭐ 9,479 | 🐛 82 | 🌐 Ruby | 📅 2026-08-31 - Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,956 | 🐛 202 | 🌐 Ruby | 📅 2026-09-02 - RailsAdmin is a Rails engine that provides an easy-to-use interface for managing your data.
...
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,306 | 🐛 8 | 🌐 Objective-C | 📅 2026-08-30 - terminal-notifier is a command-line tool to send Mac OS X User Notifications, which are available in Mac OS X 10.8 and higher.
...
* [rails-footnotes](https://github.com/josevalim/rails-footnotes) ⭐ 1,521 | 🐛 15 | 🌐 Ruby | 📅 2026-09-02 - Rails footnotes displays footnotes in your application for easy debugging, such as sessions, request parameters, cookies, filter chain, routes, queries, etc.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,894 | 🐛 155 | 🌐 Ruby | 📅 2026-09-02 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,547 | 🐛 74 | 📅 2026-07-20.
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,270 | 🐛 66 | 🌐 Ruby | 📅 2026-09-01 - Rspec-rails is a testing framework for Rails 3.x and 4.x.
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,919 | 🐛 1 | 🌐 Ruby | 📅 2026-09-02 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [Errbit](https://github.com/errbit/errbit) ⭐ 4,270 | 🐛 148 | 🌐 Ruby | 📅 2026-09-02 - Open source notifier gem compliant with Airbrake.
