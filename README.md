...
* [public\_activity](https://github.com/chaps-io/public_activity) ⭐ 2,989 | 🐛 21 | 🌐 Ruby | 📅 2026-06-08 - Easy activity tracking for models - similar to Github's Public Activity.
...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,005 | 🐛 236 | 🌐 Ruby | 📅 2026-09-17 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,040 | 🐛 1,125 | 🌐 JavaScript | 📅 2026-09-16 - Display documentation that is generated using Grape Swagger.
...
* [letter\_opener](https://github.com/ryanb/letter_opener) ⭐ 3,839 | 🐛 2 | 🌐 Ruby | 📅 2026-04-25 - Preview mail in the browser instead of sending.

## File Uploading

* [Paperclip](https://github.com/thoughtbot/paperclip) ⚠️ Archived - Easy file attachment management for ActiveRecord.
* [Carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,774 | 🐛 40 | 🌐 Ruby | 📅 2026-09-16 - Carrierwave is a classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [pg\_search](https://github.com/Casecommons/pg_search) ⭐ 1,577 | 🐛 156 | 🌐 Ruby | 📅 2026-09-07 - pg\_search builds ActiveRecord named scopes that take advantage of PostgreSQL's full text search

## Scheduled/Recurrence Jobs

* [Sidekiq](https://github.com/mperham/sidekiq) ⭐ 13,558 | 🐛 20 | 🌐 Ruby | 📅 2026-09-15 - Simple, efficient background processing for Ruby.
...
* [meta-tags](https://github.com/kpumuk/meta-tags) ⭐ 2,801 | 🐛 11 | 🌐 Ruby | 📅 2026-09-16 - Search Engine Optimization (SEO) plugin for Ruby on Rails applications.
...
* [administrate](https://github.com/thoughtbot/administrate) ⭐ 6,033 | 🐛 134 | 🌐 JavaScript | 📅 2026-09-16 - A Rails engine that helps you put together a super-flexible admin dashboard.
...
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,328 | 🐛 9 | 🌐 Objective-C | 📅 2026-08-30 - terminal-notifier is a command-line tool to send Mac OS X User Notifications, which are available in Mac OS X 10.8 and higher.
...
* [letter\_opener](https://github.com/ryanb/letter_opener) ⭐ 3,839 | 🐛 2 | 🌐 Ruby | 📅 2026-04-25 - Preview email in the default browser instead of sending it. This means you do not need to set up email delivery in your development environment, and you no longer need to worry about accidentally sending a test email to someone else's address.
...
* [rails-footnotes](https://github.com/josevalim/rails-footnotes) ⭐ 1,521 | 🐛 17 | 🌐 Ruby | 📅 2026-09-15 - Rails footnotes displays footnotes in your application for easy debugging, such as sessions, request parameters, cookies, filter chain, routes, queries, etc.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,903 | 🐛 141 | 🌐 Ruby | 📅 2026-09-17 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,548 | 🐛 73 | 📅 2026-07-20.
...
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,923 | 🐛 1 | 🌐 Ruby | 📅 2026-09-15 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,270 | 🐛 119 | 🌐 Ruby | 📅 2026-08-13 - Brakeman is a static analysis tool which checks Ruby on Rails applications for security vulnerabilities.
...
* [bundle-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 48 | 🌐 Ruby | 📅 2026-09-12 - bundler-audit is a patch-level verification tool for Bundler which checks for vulnerable versions of gems and insecure gem sources.
...
* [Errbit](https://github.com/errbit/errbit) ⭐ 4,269 | 🐛 147 | 🌐 Ruby | 📅 2026-09-17 - Open source notifier gem compliant with Airbrake.
