...
* [Devise](https://github.com/plataformatec/devise/) ⭐ 24,358 | 🐛 233 | 🌐 Ruby | 📅 2026-06-22 - Devise is a flexible authentication solution for Rails based on Warden.
...
* [Enumerize](https://github.com/brainspec/enumerize) ⭐ 1,762 | 🐛 13 | 🌐 Ruby | 📅 2026-08-04 - Enumerated attributes with I18n and ActiveRecord/Mongoid support. It can be integrated with Simple Form.
...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,005 | 🐛 243 | 🌐 Ruby | 📅 2026-08-29 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 28,993 | 🐛 1,141 | 🌐 JavaScript | 📅 2026-08-28 - Display documentation that is generated using Grape Swagger.
...
* [Carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,778 | 🐛 50 | 🌐 Ruby | 📅 2026-08-30 - Carrierwave is a classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [Sidekiq](https://github.com/mperham/sidekiq) ⭐ 13,555 | 🐛 31 | 🌐 Ruby | 📅 2026-08-17 - Simple, efficient background processing for Ruby.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,480 | 🐛 91 | 🌐 Ruby | 📅 2026-08-28 - Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [RailsAdmin](https://github.com/sferik/rails_admin) ⭐ 7,957 | 🐛 202 | 🌐 Ruby | 📅 2026-08-30 - RailsAdmin is a Rails engine that provides an easy-to-use interface for managing your data.
...
* [Ahoy](https://github.com/ankane/ahoy) ⭐ 4,480 | 🐛 6 | 🌐 Ruby | 📅 2026-08-17 - Ahoy provides a solid foundation to track visits and events in Ruby, JavaScript, and native apps.
...
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,301 | 🐛 7 | 🌐 Objective-C | 📅 2026-08-30 - terminal-notifier is a command-line tool to send Mac OS X User Notifications, which are available in Mac OS X 10.8 and higher.
...
* [byebug](https://github.com/deivid-rodriguez/byebug) ⭐ 3,349 | 🐛 99 | 🌐 Ruby | 📅 2026-07-27 - Byebug is a simple to use, feature rich debugger for Ruby 2. It uses the new TracePoint API for execution control and the new Debug Inspector API for call stack navigation, so it doesn't depend on internal core sources.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,898 | 🐛 153 | 🌐 Ruby | 📅 2026-08-30 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,548 | 🐛 74 | 📅 2026-07-20.
...
* [Capybara](https://github.com/jnicklas/capybara) ⭐ 10,171 | 🐛 21 | 🌐 Ruby | 📅 2026-07-13 - Capybara helps you test web applications by simulating how a real user would interact with your app. And drivers:
...
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,920 | 🐛 1 | 🌐 Ruby | 📅 2026-08-26 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,265 | 🐛 115 | 🌐 Ruby | 📅 2026-08-13 - Brakeman is a static analysis tool which checks Ruby on Rails applications for security vulnerabilities.
...
* [Responders](https://github.com/plataformatec/responders) ⭐ 2,058 | 🐛 10 | 🌐 Ruby | 📅 2026-08-27 - A set of Rails responders to dry up your application.
* [Slowpoke](https://github.com/ankane/slowpoke) ⭐ 395 | 🐛 0 | 🌐 Ruby | 📅 2026-04-04 - Rack::Timeout is great. Slowpoke makes it better.

## Error Logging

* [Errbit](https://github.com/errbit/errbit) ⭐ 4,271 | 🐛 141 | 🌐 Ruby | 📅 2026-08-30 - Open source notifier gem compliant with Airbrake.
