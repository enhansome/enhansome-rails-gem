...
* [Grape](https://github.com/ruby-grape/grape) ⭐ 10,008 | 🐛 251 | 🌐 Ruby | 📅 2026-09-11 - Microframework to create REST-ful APIs in Ruby.
...
* Documentation
  * [Grape Swagger UI](https://github.com/swagger-api/swagger-ui) ⭐ 29,009 | 🐛 1,128 | 🌐 JavaScript | 📅 2026-09-11 - Display documentation that is generated using Grape Swagger.
...
* [Carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,774 | 🐛 43 | 🌐 Ruby | 📅 2026-09-07 - Carrierwave is a classier solution for file uploads for Rails, Sinatra and other Ruby web frameworks.
...
* [Sidekiq](https://github.com/mperham/sidekiq) ⭐ 13,553 | 🐛 21 | 🌐 Ruby | 📅 2026-09-03 - Simple, efficient background processing for Ruby.
...
* [Resque](https://github.com/resque/resque) ⭐ 9,475 | 🐛 74 | 🌐 Ruby | 📅 2026-09-10 - Redis-backed Ruby library for creating background jobs, placing them on multiple queues, and processing them later.
...
* [administrate](https://github.com/thoughtbot/administrate) ⭐ 6,032 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-11 - A Rails engine that helps you put together a super-flexible admin dashboard.
...
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,320 | 🐛 8 | 🌐 Objective-C | 📅 2026-08-30 - terminal-notifier is a command-line tool to send Mac OS X User Notifications, which are available in Mac OS X 10.8 and higher.
...
* [RuboCop](https://github.com/bbatsov/rubocop) ⭐ 12,898 | 🐛 147 | 🌐 Ruby | 📅 2026-09-11 - Rubocop is a Ruby static code analyzer. Out of the box it will enforce many of the guidelines outlined in the community [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide) ⭐ 16,546 | 🐛 73 | 📅 2026-07-20.
...
* [SimpleCov](https://github.com/colszowka/simplecov) ⭐ 4,920 | 🐛 1 | 🌐 Ruby | 📅 2026-09-11 - SimpleCov is a code coverage analysis tool for Ruby.
...
* [Secure Headers](https://github.com/twitter/secureheaders) ⭐ 3,226 | 🐛 14 | 🌐 Ruby | 📅 2026-09-10 -  Secure Headers will automatically apply several headers that are related to security.
